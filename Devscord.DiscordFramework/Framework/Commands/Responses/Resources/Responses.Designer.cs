...
namespace Devscord.DiscordFramework.Framework.Commands.Responses.Resources {
    ...
    public class Responses {
        ...
        /// <summary>
        ///   Looks up a localized string similar to {{admin}} usunął wszystkie ostrzeżenia użytkownika {{user}}..
        /// </summary>
        public static string AllWarnsRemovedFromUser {
            get {
                return ResourceManager.GetString("AllWarnsRemovedFromUser", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to  - wyciszono na {{muteTime}}.
        /// </summary>
        public static string AntiSpamMute {
            get {
                return ResourceManager.GetString("AntiSpamMute", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Ostrzeżenie za spam na kanale: {{channelName}}.
        /// </summary>
        public static string AntiSpamWarning {
            get {
                return ResourceManager.GetString("AntiSpamWarning", resourceCulture);
            }
        }
