...
namespace Watchman.DomainModel.Configuration.Services
{
    ...
    public class ConfigurationMapperService : IConfigurationMapperService
    {
        ...
        {
            return new ConfigurationItem(((dynamic)mappedConfiguration).Value, mappedConfiguration.ServerId, mappedConfiguration.Name, new List<string> { mappedConfiguration.Group }, mappedConfiguration.SubGroup);
        }
        ...
        private IMappedConfiguration MapConfiguration(ConfigurationItem configurationItem)
        {
            ...
            mappedConfiguration!.Group = (dynamic)configurationItem.Groups.FirstOrDefault();
