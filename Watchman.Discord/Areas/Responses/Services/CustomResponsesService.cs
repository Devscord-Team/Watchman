...
{
    public interface ICustomResponsesService
    {
    ...
    public class CustomResponsesService : ICustomResponsesService
    {
        private readonly ICommandBus _commandBus;
        private readonly IQueryBus _queryBus;

        public CustomResponsesService(IQueryBus queryBus, ICommandBus commandBus)
        {
